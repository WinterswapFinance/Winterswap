...
import './interfaces/IWinterswapV2HRC20.sol';
import './libraries/SafeMathSwap.sol';

contract WinterswapV2HRC20 is IWinterswapV2HRC20 {
    using SafeMathSwap for uint;

    string override public constant name = 'Winterswap V2';
    string override public constant symbol = 'WNT-V2';
    ...
    function permit(address owner, address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) override external {
        require(deadline >= block.timestamp, 'WinterswapV2: EXPIRED');
        ...
        require(recoveredAddress != address(0) && recoveredAddress == owner, 'WinterswapV2: INVALID_SIGNATURE');
