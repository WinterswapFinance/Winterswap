...
module.exports = {
  ...
  networks: {
    ...
    development: {
      network_id: '711', // * for Match any network id
      gas: 8000000,
      gasPrice: 20000000000,
      provider: () =>
        new HDWalletProvider({
          mnemonic: {
            phrase: development_mnemonic
          },
    ...
    // mainnet: {
    //   network_id: '1', // * for Match any network id
    //   gas: 6721975,
    //   gasPrice: 30000000000, //30GWei
    //   provider: function () {
    //     return new MultiAccountWalletProvider(infuraMainnet, [
    //       adminDeployerPrivateKey,
    //       upxDeployerAndAdmin
    //     ]);
    //   },
    // }
